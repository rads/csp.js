...
var operations = {
  take: function(machine, instruction) {
    ...
    var result = chans.take(channel, handler);
  ...
  put: function(machine, instruction) {
    ...
    var result = chans.put(channel, value, handler);
  ...
  alts: function(machine, instruction) {
    ...
    for (var i = 0; i < len; i++) {
      ...
      if (Array.isArray(channel)) {
        ...
        result = chans.put(putChan, putValue, handler);
        ...
        result = chans.take(channel, handler);
